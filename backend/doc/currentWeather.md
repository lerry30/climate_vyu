# Transform Raw Values to Readable Units

## Struct

All properties that hold readable values and can be converted to json format.
...
Return an empty instance of Struct <code>CurrentWeatherData</code>
...
Transformed raw data from numeric to string formatted values with indicated units.
